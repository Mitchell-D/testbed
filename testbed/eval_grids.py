...
domains = [
        ...
        GridDomain(
            ...
            tiles=[
                GridTile(
                    region="nw", px_bounds=(80,None,35,55),
                    global_px_offset=(0,0)),
                GridTile(
                    region="sw", px_bounds=(None,10,35,55),
                    global_px_offset=(98,0)),
                ],
            mosaic_shape=(2,1),
            start_time=datetime(2018, 1, 1, 0),
        ...
        GridDomain(
            name="lt-fourcorners",
            tiles=[
                GridTile(region="nw", px_bounds=(85,None,115,135),
                    global_px_offset=(0,0)),
                GridTile(region="sw", px_bounds=(0,15,115,135),
                    global_px_offset=(98,0)),
                ],
            mosaic_shape=(2,1),
            start_time=datetime(2018, 1, 1, 0),
        ...
        GridDomain(
            name="lt-atlanta",
            tiles=[
                GridTile(region="se", px_bounds=(25,28,13,17),
                    global_px_offset=(98,308)),
                ],
            mosaic_shape=(1,1),
            start_time=datetime(2018, 1, 1, 0),
...
def get_grid_evaluator_objects(eval_types:list, model_dir:tt.ModelDir,
    ...
    absolute_error_relevant = [
            ...
            "pixelwise-time-stats", "hist-weasd-temp", "hist-weasd-increment",
            ]
