...
\usepackage{float} % demand table position
\usepackage{rotating} % sideways tables
\renewcommand{\arraystretch}{.2} % table rows width smaller
...
\usepackage[
    ...
    maxbibnames=9,
    minbibnames=5,
    uniquelist=false, % why have to do this?
    %citestyle=authoryear,
    %bibstyle=mla,
]{biblatex}
...
% --- heavily penalize url overflow in bib --- %
\setcounter{biburllcpenalty}{7000}
\setcounter{biburlucpenalty}{8000}
\addbibresource{dodson_masters-thesis.bib}
\usepackage{xurl}
