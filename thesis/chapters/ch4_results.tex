...
\begin{figure}[hp!]
    ...
    \caption{Gridded MAE and bias in state for best FNN at each depth level, evaluated on full test set (2018-2023)}
    \label{accfnn-rsm-8-grid-full}
\end{figure}
...
\begin{figure}[hp!]
    ...
    \caption{Gridded MAE and bias in state for best LSTM-SOILM at each depth level, evaluated on full test set (2018-2023)}
    \label{lstm-20-grid-full}
\end{figure}
...
\begin{figure}[hp!]
    ...
    \caption{Gridded MAE and bias in state for best LSTM-RSM at each depth level, evaluated on full test set (2018-2023)}
    \label{lstm-rsm-9-grid-full}
\end{figure}
...
\begin{sideways}
    \begin{tabular}{c|c|c|c|c|c|c }
    \small
Name & Desc & Weights & state mae & state cc & info-loss & fi \\
\multirow{3}{6em}{lstm-rsm-9} & \multirow{3}{16em}{No static conditions, small residual magnitude bias} & \multirow{3}{4em}{48667} & 0.015 & 0.932 & 0.970 & 0.389 \\ & & & 0.009 & 0.922 & 0.941 & 0.352 \\ & & & 0.007 & 0.877 & 0.958 & 0.288 \\
\multirow{3}{6em}{lstm-rsm-34} & \multirow{3}{16em}{Negating Leaf Area Index} & \multirow{3}{4em}{48603} & 0.013 & 0.942 & 0.927 & 0.406 \\ & & & 0.008 & 0.915 & 0.916 & 0.364 \\ & & & 0.007 & 0.888 & 0.946 & 0.294 \\
\multirow{3}{6em}{lstm-rsm-35} & \multirow{3}{16em}{Negating Vegetation} & \multirow{3}{4em}{48603} & 0.016 & 0.931 & 1.000 & 0.372 \\ & & & 0.009 & 0.918 & 0.954 & 0.346 \\ & & & 0.008 & 0.855 & 1.003 & 0.268 \\
\multirow{3}{6em}{lstm-rsm-36} & \multirow{3}{16em}{Negating Temperature} & \multirow{3}{4em}{48603} & 0.016 & 0.925 & 1.007 & 0.372 \\ & & & 0.010 & 0.912 & 0.964 & 0.339 \\ & & & 0.007 & 0.880 & 0.970 & 0.280 \\
\multirow{3}{6em}{lstm-rsm-37} & \multirow{3}{16em}{Negating Humidity} & \multirow{3}{4em}{48603} & 0.013 & 0.938 & 0.968 & 0.389 \\ & & & 0.009 & 0.919 & 0.942 & 0.352 \\ & & & 0.007 & 0.884 & 0.991 & 0.273 \\
\multirow{3}{6em}{lstm-rsm-38} & \multirow{3}{16em}{Negating Precipitation} & \multirow{3}{4em}{48603} & 0.014 & 0.936 & 0.938 & 0.402 \\ & & & 0.008 & 0.919 & 0.925 & 0.361 \\ & & & 0.007 & 0.860 & 0.917 & 0.306 \\
\multirow{3}{6em}{lstm-rsm-39} & \multirow{3}{16em}{Negating Wind Magnitude} & \multirow{3}{4em}{48667} & 0.014 & 0.940 & 0.942 & 0.401 \\ & & & 0.009 & 0.922 & 0.948 & 0.352 \\ & & & 0.007 & 0.882 & 0.973 & 0.280 \\
\multirow{3}{6em}{lstm-rsm-40} & \multirow{3}{16em}{Negating Downward LW Radiation} & \multirow{3}{4em}{48603} & 0.015 & 0.925 & 1.012 & 0.371 \\ & & & 0.009 & 0.916 & 0.955 & 0.343 \\ & & & 0.007 & 0.890 & 0.949 & 0.289 \\
\multirow{3}{6em}{lstm-rsm-41} & \multirow{3}{16em}{Negating Downward SW Radiation} & \multirow{3}{4em}{48603} & 0.016 & 0.923 & 1.072 & 0.347 \\ & & & 0.009 & 0.914 & 0.967 & 0.338 \\ & & & 0.007 & 0.877 & 0.962 & 0.284 \\
\multirow{3}{6em}{lstm-rsm-42} & \multirow{3}{16em}{Negating Precipitation} & \multirow{3}{4em}{48603} & 0.088 & 0.348 & 1.621 & 0.167 \\ & & & 0.029 & 0.590 & 1.448 & 0.149 \\ & & & 0.013 & 0.686 & 1.312 & 0.138 \\
\multirow{3}{6em}{lstm-rsm-43} & \multirow{3}{16em}{Negating Snow} & \multirow{3}{4em}{48635} & 0.016 & 0.924 & 0.999 & 0.377 \\ & & & 0.010 & 0.906 & 0.968 & 0.336 \\ & & & 0.008 & 0.877 & 1.002 & 0.267 \\
\multirow{3}{6em}{lstm-rsm-44} & \multirow{3}{16em}{Negating Soil Texture} & \multirow{3}{4em}{48475} & 0.019 & 0.914 & 1.102 & 0.338 \\ & & & 0.013 & 0.880 & 1.081 & 0.287 \\ & & & 0.009 & 0.851 & 1.057 & 0.241 \\
\multirow{3}{6em}{lstm-rsm-45} & \multirow{3}{16em}{Negating Elevation} & \multirow{3}{4em}{48539} & 0.014 & 0.937 & 0.943 & 0.401 \\ & & & 0.009 & 0.915 & 0.904 & 0.367 \\ & & & 0.007 & 0.892 & 0.960 & 0.287 \\
\end{sideways}
    \caption{Bulk statistic results for lstm-rsm-9 variants trained with individual features excluded}
    \label{feat-variants-table}
\end{table}
...
\begin{sideways}
    ...
    \small
Name & Desc & Weights & state mae & state cc & info-loss & fi \\
\multirow{3}{6em}{lstm-rsm-9} & \multirow{3}{16em}{MAE loss, $\gamma=10$, $\lambda=1.$} & 0.015 & 0.932 & 0.970 & 0.388 \\ & & & 0.009 & 0.923 & 0.943 & 0.350 \\ & & & 0.007 & 0.876 & 0.960 & 0.287 \\
\hline
\hline
\multirow{3}{6em}{lstm-rsm-51} & \multirow{3}{16em}{MAE loss, $\gamma=0$, $\lambda=1$} & 0.015 & 0.936 & 0.925 & 0.408 \\ & & & 0.009 & 0.913 & 0.904 & 0.368 \\ & & & 0.007 & 0.883 & 0.933 & 0.298 \\
\hline
\multirow{3}{6em}{lstm-rsm-50} & \multirow{3}{16em}{MAE loss, $\gamma=50$, $\lambda=1$} & 0.016 & 0.926 & 1.031 & 0.362 \\ & & & 0.012 & 0.875 & 1.013 & 0.316 \\ & & & 0.009 & 0.842 & 1.085 & 0.233 \\
\hline
\multirow{3}{6em}{lstm-rsm-48} & \multirow{3}{16em}{MAE loss, $\gamma=100$, $\lambda=1$} & 0.017 & 0.921 & 1.062 & 0.348 \\ & & & 0.013 & 0.889 & 1.057 & 0.297 \\ & & & 0.010 & 0.779 & 1.119 & 0.217 \\
\hline
\multirow{3}{6em}{lstm-rsm-49} & \multirow{3}{16em}{MAE loss, $\gamma=500$, $\lambda=1$} & 0.021 & 0.904 & 1.117 & 0.325 \\ & & & 0.015 & 0.856 & 1.125 & 0.271 \\ & & & 0.012 & 0.741 & 1.220 & 0.176 \\
\hline
\hline
\multirow{3}{6em}{lstm-rsm-53} & \multirow{3}{16em}{MAE loss, $\gamma=10$, $\lambda=.9995$} & 0.014 & 0.940 & 0.959 & 0.392 \\ & & & 0.009 & 0.923 & 0.931 & 0.355 \\ & & & 0.007 & 0.866 & 0.969 & 0.281 \\
\hline
\multirow{3}{6em}{lstm-rsm-54} & \multirow{3}{16em}{MAE loss, $\gamma=10$, $\lambda=.95$} & 0.012 & 0.942 & 1.019 & 0.366 \\ & & & 0.008 & 0.929 & 0.983 & 0.330 \\ & & & 0.007 & 0.899 & 0.990 & 0.270 \\
\hline
\multirow{3}{6em}{lstm-rsm-55} & \multirow{3}{16em}{MAE loss, $\gamma=10$, $\lambda=.5$} & 0.016 & 0.911 & 1.364 & 0.243 \\ & & & 0.010 & 0.903 & 1.225 & 0.228 \\ & & & 0.007 & 0.858 & 1.148 & 0.201 \\
\hline
\hline
\hline
\multirow{3}{6em}{lstm-rsm-56} & \multirow{3}{16em}{MSE loss, $\gamma=10$, $\lambda=1.$} & \multirow{3}{4em}{48667} & 0.024 & 0.893 & 1.194 & 0.295 \\ & & & 0.018 & 0.791 & 1.176 & 0.243 \\ & & & 0.014 & 0.640 & 1.344 & 0.132 \\
\hline
\hline
\end{sideways}
