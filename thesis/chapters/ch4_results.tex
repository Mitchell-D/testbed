...
\begin{figure}[hp!]
    ...
    \caption{True variation in weekly average RSM per soil texture for each layer: 0-10cm (top) 10-40cm (middle), and 40-100cm (bottom).}
...
\begin{figure}[h!]
    ...
    \includegraphics[width=.99\linewidth,draft=false]{figures/lt-miss-alluvial/eval-grid_lt-miss-alluvial_lstm-rsm-9_pixelwise-time-stats_abs-err_qtrly-err-state-all-3.png}

    \includegraphics[width=.99\linewidth,draft=false]{figures/lt-miss-alluvial/eval-grid_lt-miss-alluvial_lstm-rsm-9_pixelwise-time-stats_bias_qtrly-err-state-all-3.png}

    \caption{Mean absolute error (top) and bias (bottom) in the Mississippi Alluvial domain at each depth level (left to right: 0-10cm, 10-40cm, 40-100cm) for the full test period (2018-2023).}
...
\begin{figure}[h!]
    ...
    \includegraphics[width=.99\linewidth,draft=false]{figures/lt-miss-alluvial/eval-grid_lt-miss-alluvial-c01_lstm-rsm-9_rsm_keep-all_bias_forcings.png}

    \includegraphics[width=.99\linewidth,draft=false]{figures/lt-miss-alluvial/eval-grid_lt-miss-alluvial-c01_lstm-rsm-9_rsm_keep-all_bias_state-seq-textures-all_labeled.png}
