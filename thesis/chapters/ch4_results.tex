...
Figure \ref{lt_mae-bias_high-plains} displays the average error rates and biases in each layer per season. During the winter, it is clear that the worst-performing areas in every layer are closely associated with the sandy soil texture, however these high error rates do not correspond to a strong bias in either direction. As the ground thaws in the spring, the clay soil textures in the Northern portion of the region have higher error rates in the first two layers, though these also are not conclusively associated with strong bias: even in the surface layer, which is typically dry-biased in all seasons, there are some clay textures with a wet bias in the March-May time range.
