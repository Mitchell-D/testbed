...
if __name__=="__main__":
    ...
    model_maps = {
            "lstm-rsm-9":"$\gamma=10$, $\\rho=1$",
            "lstm-rsm-51":"$\gamma=0$, $\\rho=1$",
            "lstm-rsm-50":"$\gamma=50$, $\\rho=1$",
            "lstm-rsm-48":"$\gamma=100$, $\\rho=1$",
            "lstm-rsm-49":"$\gamma=500$, $\\rho=1$",
            "lstm-rsm-53":"$\gamma=10$, $\\rho=.9995$",
            "lstm-rsm-54":"$\gamma=10$, $\\rho=.95$",
            "lstm-rsm-55":"$\gamma=10$, $\\rho=.5$",
    ...
    for  fk in state_increment_hists.keys():
        ...
        ## absolute error
        domain,codomain,labels = map(list,zip(*[(
