...
dynamic_coeffs = [
        ('lai', array([2.98181285, 1.64273885])),
        ('veg', array([0.37530722, 0.26120498])),
        ('tmp', array([285.7206664 ,  11.93766774])),
        ('spfh', array([0.0068803 , 0.00468152])),
        ('pres', array([92803.06962 ,  7699.616714])),
        ('ugrd', array([0.76728547, 2.9982088 ])),
        ('vgrd', array([0.64238808, 3.25051813])),
        ('dlwrf', array([304.1775354,  68.4974331])),
        ('ncrain', array([0.0470666 , 0.19641987])),
        ('cape', array([202.2872838, 527.7525554])),
        ('pevap', array([0.20229804, 0.2735195 ])),
        ('apcp', array([0.09068938, 0.63642765])),
        ('dswrf', array([194.1786308, 265.0293252])),
        ('soilm-10', array([24.30383426,  8.65985905])),
        ('soilm-40', array([73.16257206, 21.83291832])),
        ('soilm-100', array([136.6062034 ,  40.63990632])),
        ('soilm-200', array([239.5253568 ,  65.98121262])),
        ]
